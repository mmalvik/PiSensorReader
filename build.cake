...
var destinationDirectory = Argument("destinationDirectory", @"<dir>");
var username = Argument("username", "<username>");
var sessionname = Argument("sessionname", "<sessionName>");
var executableName = Argument("executableName", "<exe>");
...
var projectFile = "./" + "src/" + executableName + ".csproj";
